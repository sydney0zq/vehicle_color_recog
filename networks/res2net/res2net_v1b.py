...
def custom_load_state_dict(url, model):
    ...
    del(pretrained_dict)
    print("load/remove {}/{} model dict entries...".format(len(pretrained_dict_update), len(pretrained_dict_remove)))
...
def res2net101_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        try:
            ...
            custom_load_state_dict(model_urls['res2net101_v1b_26w_4s'], model)
    return model
